...
%-------------------OutPut Query------------------------>
% ?- canget(state(atdoor, onfloor, atwindow, hasnot), Plan). #query
% Plan = [walk(atdoor, atwindow), push(atwindow, middle), climb, grasp] #output
% Yes

% ?- canget(state(atwindow, onbox, atwindow, hasnot), Plan ). #query
% No #output
